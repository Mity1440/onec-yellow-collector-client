...
// Преобразовать в структуру из соответствия.
// 
// Параметры:
...
Функция ПреобразоватьВСтруктуруИзСоответствия(Источник) Экспорт
	...
	Если ТипЗнч(Источник) = Тип("Соответствие") Тогда
		...
		Для Каждого КлючЗначение Из Источник Цикл
			Попытка
				СтруктураРезультат.Вставить(КлючЗначение.Ключ, 
				                 ПреобразоватьВСтруктуруИзСоответствия(КлючЗначение.Значение));
			Исключение
	...
	ИначеЕсли ТипЗнч(Источник)=Тип("Массив") Тогда
		...
		Для Каждого ЭлементИсточника Из Источник Цикл
			МассивРезультат.Добавить(ПреобразоватьВСтруктуруИзСоответствия(ЭлементИсточника));
		КонецЦикла;
...
Функция СдвинутьДатуНаПериод(ДатаСдвига, Период, КоличествоПериодов) Экспорт
	
	Если ВРег(Период) = "ДЕНЬ" Тогда
		Возврат ДатаСдвига + СекундВДне() * КоличествоПериодов;
	КонецЕсли;
	Возврат ДатаСдвига;
